...
@property (nonatomic, copy)SelectAssetsBlock selectAssetBlock;
// Datas
...
- (void)getselectAssets:(SelectAssetsBlock)selectAssetBlock
{
    self.selectAssetBlock = [selectAssetBlock copy];
...
- (void)dealloc{
    ...
    // 赋值给上一个控制器
    if (_selectAssetBlock) {
        _selectAssetBlock(self.selectAssets);
    }
