...
@implementation TailorImageView
...
//        NSLog(@"self.overlayView.rectArray = %@", self.overlayView.rectArray[i]);
        [mArray addObject:[self cropImageWithScale:scale Rect:rect]];
    }
    
    NSDictionary * dic = @{@"ImageArr":mArray, @"Rect":NSStringFromCGRect(rect), @"imageViewRecf":NSStringFromCGRect(self.imageView.frame)};
