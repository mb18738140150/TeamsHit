...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MLPhotoPickImageView *cellImgView = nil;
    if ([[cell.contentView.subviews lastObject] isKindOfClass:[MLPhotoPickImageView class]]) {
        cellImgView = (MLPhotoPickImageView *)[cell.contentView.subviews lastObject];        cellImgView.maskViewFlag = YES;
    }else{
        cellImgView = [[MLPhotoPickImageView alloc] initWithFrame:cell.bounds];
...
- (void)photoPickerClickTickButton:(UIButton *)tickButton{
    ...
    MLPhotoPickImageView *pickerImageView = [cell.contentView.subviews lastObject];
    // 如果没有就添加到数组里面，存在就移除
    ...
    pickerImageView.maskViewFlag = ([pickerImageView isKindOfClass:[MLPhotoPickImageView class]]) && !pickerImageView.isMaskViewFlag;
}
