...
@interface TelephoneRechargeViewController ()<WKUIDelegate, WKNavigationDelegate>
{
    WKWebView *webView;
}
...
- (void)viewDidLoad {
    ...
    NSString * urlStr = [NSString stringWithFormat:@"http://www.wap.mstching.com/account/applogin?username=%@&password=%@&backurl=/phone/recharge?from=app",[[NSUserDefaults standardUserDefaults] objectForKey:@"AccountNumber"], [[NSUserDefaults standardUserDefaults] objectForKey:@"Password"]];
